...
SECRET_KEY = 'django-insecure-vy5@u521%io7g(p68!a2b6m-*^=mq54s1uv=wu=4$$%)b%l_9f'
...
MIDDLEWARE = [
    ...
    # 'django.middleware.clickjacking.XFrameOptionsMiddleware',  # XFrame 미들웨어 비활성화
]
